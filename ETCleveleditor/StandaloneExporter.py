...
##      07/29/2011 - Zachary Cummings - ZJC
##      ** exportGame
##      *** Added a check for the flag: #LoaderFlagImportArray
##      *** Upon seeing the flag, the code is output to the file to append
##      ***  the list of prefixes generated during the level editing to the
##      ***  list of prefixes that is included in the games runtime file.
##
##
##############################################################################
...
#        shutil.copy("./UIBase.py",dest)
        ...
        for line in lines:
            ...
            ## elif line.strip().startswith('#LoaderFlagImportArray'):     # ZJC - 07/29/2011: This checks to see if we are at the LoaderFlag
                ## ## print "Hey I'm at that line", line   # ZJC - 07/29/2011: Test output lines
                ## ## print base.le.prefixImportMerge      # ZJC - 07/29/2011: For verifying placement in output file
                ## for i in range(len(base.le.prefixImportMerge)):                 # ZJC - 07/29/2011: Sorts through the prefix array
                    ## name = base.le.prefixImportMerge[i]    # ZJC - 07/29/2011: Local variable to shorten the length of the next line
                    ## outputLines.append("\tprefixList.append('"+str(name)+"')\n")       # ZJC - 07/29/2011: Adds prefixs to output file list
