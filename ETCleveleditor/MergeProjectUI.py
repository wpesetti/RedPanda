...
##      ** onMerge
##      *** Added a line of code that will add any files imported to a list
##      *** that is defined in LevelEditorStart.py
##
##
##############################################################################
import wx
...
class MergeProjectUI(wx.Dialog):
    ...
    def onMerge(self, evt):
        ...
        ## base.le.prefixImportMerge.append(prefix)# ZJC - 07/27/2011: Adds name to prefix list
