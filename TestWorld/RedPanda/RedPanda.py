...
##      ** setKeyStatus
##      *** Realized the code from the last update was pointlessly complicated
##      *** Instantiated a simpler way of checking to see what the model name should be
##      ***  based on the location of the word "mod" in the name.
##
##      07/29/2011 - Zachary Cummings - ZJC
##      ** setKeyStatus
##      *** Adjusted the code so that there is a flag to be read by the
##      ***  StandaloneExporter. Also there is an empty array initialized
##      ***  that will be populated upon generation of the output file.
##      *** There is then a check that will verify that the name of the animation
##      ***  is not in the prefix list, and adjust the 'name' of the character
##      ***  being animated accordingly.
##
##      07/26/2011 - Zachary Cummings - ZJC
##      ** setKeyStatus
##      *** Adjusted the animations so that they run based off of the
##      *** model they are being called on. Appropriately named animations
##      *** will be run dynamically instead of hard coded in.
##
##
##############################################################################
...
GAMEPLAY_FOLDER = 'C:/Users/Acer/Documents/RedPanda/ETCleveleditor'
IN_DEVELOP = False
...
JOURNAL_FILE = 'RedPanda.journal'
SCRIPTS_FILE = 'Scripts.py'

from Scripts import *
INVENTORY_FILE = 'RedPanda.inventory'
